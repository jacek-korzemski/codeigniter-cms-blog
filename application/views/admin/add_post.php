<div class="content">
    ...
    <?php echo form_open('admin/posts/add'); ?>
        <div class="flex-between flex-wrap">
            ...
            <div class="form-fields w-100" style="display: none;">
                <input type="text" name="post_slug" readonly/>
                <p>Url</p>
            </div>
        </div>
        ...
        <div class="form-fields">
            <input type="text" name="seo_description" required />
            <p>SEO - Opis</p>
        </div>
        <div class="flex-between">
            <div class="form-fields w-50">
