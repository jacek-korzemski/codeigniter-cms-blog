<div class="content">
    ...
    <div class="default-form edit-page">
        <?php echo form_open('admin/pages/edit/'.$id); ?>
            ...
            <div class="form-fields">
                <?php list_templates($template); ?>
                <p>Szablon</p>
                <br>
            </div>
            <div class="form-fields text-editor">
                <textarea id="ckeditor" name="body"><?= $content; ?></textarea>
            </div>
